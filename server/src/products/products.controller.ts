...
import { IsArray, IsInt, IsOptional, IsString, IsUrl, Max, Min, MinLength } from 'class-validator';
...
class ReviewDto { @IsInt() @Min(1) @Max(5) rating!: number; @IsString() @MinLength(3) comment!: string; }
