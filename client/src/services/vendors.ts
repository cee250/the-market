...
export interface ManagedVendor { id: string; userId: string; name: string; email: string; businessName: string; slug: string; phone: string; location: string; status: string; emailVerified: boolean; createdAt: string; updatedAt: string; latestPayment: { amount: number; currency: string; status: string } | null }
