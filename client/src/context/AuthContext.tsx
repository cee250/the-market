...
interface AuthContextValue {
  ...
  registerVendor: (input: { name: string; businessName: string; email: string; phone: string; location: string; password: string; confirmPassword: string; termsVersion: string; packageName: string }) => Promise<{ user: User; verificationToken?: string }>;
  logout: () => Promise<void>;
}
